...
def test_single():
    ...
    print("huh")
    jax_renderer = JAXRenderer(model, height=128, width=128, num_workers=1)
...
def test_1d_vectorized():
    ...
    # Create a renderer
    renderer = Renderer(model, height=128, width=128)
    jax_renderer = JAXRenderer(model, height=128, width=128, num_workers=16)
...
def test_destructor():
    ...
    jax_renderer = JAXRenderer(model, height=128, width=128, num_workers=3)
